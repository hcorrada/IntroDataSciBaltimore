...
Were more males or females arrested on Valentine's Day, and for which crimes?

```{r}

vday = function() {
  vdaytab <- table(arrest_tab$arrestDate == "02/14/2011", arrest_tab$sex)
  mytab = as.data.frame.matrix(vdaytab)
  mytab$ratio = mytab$F/mytab$M
  mytab$ratio <- round(mytab$ratio, 3)
  mytab
}
vday()
```
