...
#### Zach Jiroun Des Chandhok Jose Zamora

What question are you asking?:

On what day were the most arrests made?

What is the code you use to answer it?:

```{r Zach Jiroun, Des Chandhok, Jose Zamora}
head(sort(table(arrest_tab$arrestDate), decreasing=TRUE))
```

What did you observe?

The day with the most arrests during this 2 year period was May 25, 2011. On that day, there was 250 arrests. On a side note, it seems that the days with the most arrests occured at mostly at the end of the month.
